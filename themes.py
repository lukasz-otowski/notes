...
disase
	tumor
		benign_tumor
			...
			cystadenoma
			liver_cell_adenoma
	https://www.wikiwand.com/pl/Matematyka#Badania_oko%C5%82omatematyczne		hydatiform_mole
	...
	carcinogenesis
		carcinogens
			...
			chemical
				...
				thorotrast
					s_pseudogonas
				compounds_formed_during_incomplete_combustion_(not_necessarily_cigarettes)_due_to_too_little_oxygen
					cause_radicals
					cause_aromatic_compounds_tarry_substances_including_aromatic_hydrocarbons_anthracenes_benzopyrene_aromatic_amines_nitrosamines
				dioxins
				aflatoxin
			biological
				hiv
			...
			viruses
				HHV8_herpes_virus8
					kaposis_sarcoma
				HPV_human_papilloma_virus
					cervix
					vulva
					penis
				HBV_HCV_hepatitis_B_and_C
					hepatocellular_carcinoma
				EBV_epstein_barr_virus
					probably_hodgson
					nasopharyngeal_cancer
					burkitts_lymphoma
					some_rare_forms_of_lymphoma
				HTLV_I_HTLV_II
					acute_leukemia_from_t_lymphocytes
		mutation
		intense_mitosis_of_altered_cells
		overgrowth_of_healthy_tissues
		angiogenesis
		migration
		...
		html
			...
			svg
				'<svg width="600" height="600">'
					...
					'<line x1="100" y1="100" x2="120" y2="300" stroke="grey" stroke-width="2"></line>'
					'<path d="M 150 50 L 75 200 L 225 200 Z" fill="orange"></path>'
					'<path d="M 150 50 L 75 200 L 225 200 C 225 200 150 150 150 50" fill="green"></path>'
				'</svg>'
		css
			property_flexbox
				...
				"justify-content: flex-start/flex-end/center/space-between/space-around/space-evenly;"#auto creating margins
				"align-self:flex-start/flex-end/center;"#vertical self alignment of specific item
				"align-items:flex-start/flex-end/center/stretch;"#vertical alignment of content
	...
	algorithm
		...
		binary_tree
			depth_first_traversal
				pre_order_traversal#visit the parent first and then left and right children;
				in_order_traversal#visit the left child, then the parent and the right child;
